...
const MarketingPage = () => {
  return (
    <div className='flex items-center justify-center flex-col h-screen gap-4'>
      ...
      <h1 className='text-3xl md:text-6xl text-center text-neutral-800 font-medium'>
        Tasky helps team move
      </h1>
      <div className='text-3xl md:text-6xl bg-gradient-to-r from-lochmara to-amaranth text-white px-4 p-2 rounded-md font-medium w-fit'>
        work forward.
      </div>
